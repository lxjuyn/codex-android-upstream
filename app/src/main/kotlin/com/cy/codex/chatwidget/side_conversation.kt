...
/** Developer instructions pinned on the fork, verbatim from `app/side.rs`. */
internal const val SideDeveloperInstructions: String = """You are in a side conversation, not the main thread.
        ...
        buildJsonArray {
            add(
                buildJsonObject {
                    ...
                    put("text", JsonPrimitive(SideBoundaryPrompt))
                },
            )
        },
    )
