...
fun ApprovalNoticeBar(
    ...
    Surface(
        ...
        Column(
            modifier = Modifier.padding(horizontal = UiConsts.Space12, vertical = UiConsts.Space10),
                ...
                Surface(
                    modifier =
                        Modifier.fillMaxWidth().semantics {
                            onClick(label = threadName(entry.threadId), action = null)
                        },
                    shape = shapeRow,
                    ...
                    Row(
                        modifier = Modifier.padding(vertical = UiConsts.Space3),
                        verticalAlignment = Alignment.CenterVertically,
                    ) {
                        Text(
                            text =
                                stringResource(
                                    R.string.approval_notice_foreign,
                                    threadName(entry.threadId),
                                ),
            ...
            if (reviews.isNotEmpty()) {
                ...
                reviews.take(UiConsts.ApprovalNoticeReviews).forEach { review ->
                    Text(
                        text =
                            stringResource(R.string.approval_notice_review_detail, review.detail),
